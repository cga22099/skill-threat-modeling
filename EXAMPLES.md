...
中文版：[EXAMPLES-cn.md](EXAMPLES-cn.md)

---

## KB Query Templates by Phase

> **Important**: Query templates organized by phase. Execute queries in the correct phase to maintain strict 8-phase serial execution order.
